...
class Recognizer(AudioSource):
    ...
    def adjust_for_ambient_noise(self, source: Microphone, duration=1):
        """
    ...
    def listen(self, source: Microphone, timeout=None, phrase_time_limit=None, snowboy_configuration=None, stream=False):
        """
